...
| Skill | Description |
|-------|-------------|
| [chatgpt-pro-coding-agent](./skills/engineering/chatgpt-pro-coding-agent/SKILL.md) | Use ChatGPT Pro Web as an external senior engineer through a scoped CodexPro MCP workspace and Camoufox bridge, keep every task inside one fixed ChatGPT Project, and leave permissions, integration, and independent QA with Codex. |
...
| [brand-competitor-analysis](./skills/marketing/brand-competitor-analysis/SKILL.md) | Turn a company URL into a research-backed competitive landscape: discover and verify 30–50 qualified rivals across regions and market tiers, rank them by best-available value, and deliver a self-contained HTML report with branding, marketing, and sales implications. |
