...
| Skill | Description |
|-------|-------------|
| [chatgpt-pro-coding-agent](./skills/engineering/chatgpt-pro-coding-agent/SKILL.md) | Use ChatGPT Pro Web as an external senior engineer through a scoped CodexPro MCP workspace and Camoufox bridge, while Codex owns permissions, integration, and independent QA. |
