...
| Skill | 說明 |
|-------|------|
| [chatgpt-pro-coding-agent](./skills/engineering/chatgpt-pro-coding-agent/SKILL.md) | 透過受限的 CodexPro MCP workspace 與 Camoufox bridge，讓 ChatGPT Pro 擔任外部資深工程師；所有任務固定歸檔在同一個 ChatGPT Project，Codex 保留權限、整合與獨立 QA。 |
